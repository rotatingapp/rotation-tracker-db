-- 003_security_definer_rpc.sql
-- Creates the get_vessel_rotations SECURITY DEFINER RPC.
-- SECURITY DEFINER bypasses RLS to JOIN crew app tables (rotations, profiles)
-- with management tables (crew_assignments, crew_positions).
-- CREATE OR REPLACE is idempotent — safe to re-run.
-- Source: 01-RESEARCH.md "Security-Definer RPC" + STATE.md decision
